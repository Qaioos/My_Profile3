        ...
        >
            <div className="max-w-[1640px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    ...
                    <article className="lg:col-span-7 rounded-2xl bg-[#10121A] border border-white/10 hover:border-[#FF5500]/50 p-6 sm:p-8 flex flex-col justify-between transition-all duration-300 hover:shadow-[0_0_35px_rgba(255,85,0,0.15)] group">
                        <div className="flex flex-col gap-6">
                            <div className="flex items-center justify-between text-outline font-label-mono-sm text-xs">
                                <span className="text-white/60">
                                    INDEX: 01 // 03
                                </span>
                                <span className="px-2.5 py-0.5 rounded bg-[#FF5500]/10 text-[#FF5500] border border-[#FF5500]/30 font-semibold">
                                    YEAR: 2025
                                </span>
                            </div>
                            {/* <!-- Visual Canvas / Preview Simulation --> */}
                            <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden bg-[#090A0F] border border-white/10 group-hover:border-[#FF5500]/30 transition-all">
                                <div
                                    className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105 opacity-85"
                                    style={{ backgroundImage: `url(${img})` }}
                                ></div>
                                <div className="absolute inset-0 bg-gradient-to-t from-[#090A0F] via-[#090A0F]/30 to-transparent"></div>
                                <div className="absolute top-3 left-3 px-2.5 py-1 rounded bg-[#090A0F]/80 border border-white/10 backdrop-blur-md font-label-mono-sm text-[11px] text-[#8B5CF6]">
                                    SPATIAL OPERATING SYSTEM
                                </div>
                                <div className="absolute top-3 right-3 px-2.5 py-1 rounded bg-[#FF5500] text-white font-label-mono-sm text-[11px] font-bold">
                                    WebGL Compute Particles
                                </div>
                                <div className="absolute bottom-4 left-4 right-4 p-3 rounded-lg bg-[#10121A]/90 border border-white/10 backdrop-blur-md flex items-center justify-between text-xs font-label-mono-sm">
                                    <span className="text-white/80">
                                        SIMULATED CORE: 120,000 NODES
                                    </span>
                                    <span className="text-[#FF5500]">
                                        0.02ms FRAME COMPUTE
                                    </span>
                                </div>
                            </div>
                            {/*  <!-- Content & Description --> */}
                        ...
                        <div className="flex items-center justify-between pt-6 mt-6 border-t border-white/10">
                            <a
                                className="inline-flex items-center gap-2 text-xs font-label-mono-sm font-bold uppercase text-[#FF5500] hover:text-white transition-colors"
                                href="#contact"
                            >
