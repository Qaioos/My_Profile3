...
const Header = () => {
    ...
    return (
        <header className="fixed max-w-[1440px] max-w-[90%] top-0 inset-x-0 z-400 backdrop-blur-xl bg-[#090A0F]/85 border-b border-white/10 shadow-2xl transition-all duration-300">
